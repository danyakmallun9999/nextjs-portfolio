---
title: 'Cara Deploy Laravel 12 di Vercel with Supabase'
...
Namun, karena Laravel memiliki sifat **_stateless_** dan Vercel berbasis **_serverless_**, ada beberapa trik khusus agar Laravel berjalan mulus di Vercel. Mari kita bedah...
