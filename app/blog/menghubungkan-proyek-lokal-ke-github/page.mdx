export const metadata = {
  ...
  description:
    'Panduan lengkap untuk menghubungkan proyek lokal ke GitHub. Tutorial ini mencakup persiapan, inisialisasi Git, koneksi via HTTPS atau SSH, serta workflow harian untuk developer.',
  alternates: {
    canonical: '/blog/tutorial-koneksi-github',
  },
  openGraph: {
    title: 'Tutorial GitHub: Cara Menghubungkan Proyek Lokal ke Repository',
    description: 'Pelajari langkah-langkah mudah menghubungkan proyek lokal ke GitHub menggunakan HTTPS atau SSH, dilengkapi tips dan workflow standar untuk developer.',
    url: 'https://danyakmallun.com/blog/tutorial-koneksi-github',
    type: 'article',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ilustrasi koneksi GitHub dengan simbol komputer, kode, dan repositori.',
      },
    ],
  },
  twitter: {
    ...
    title: 'Tutorial GitHub: Cara Menghubungkan Proyek Lokal ke Repository',
    description: 'Panduan praktis untuk menghubungkan proyek lokal ke GitHub. Lengkap dengan instruksi HTTPS, SSH, dan tips workflow.',
    images: [
      {
        url: '/posts/cover-github-connect.png',
        width: 1200,
...
<Cover
  ...
  alt="Ilustrasi abstrak yang menggambarkan koneksi kode lokal ke GitHub dengan jaringan dan repositori."
  caption="Tutorial: Cara Menghubungkan Proyek ke GitHub"
/>
