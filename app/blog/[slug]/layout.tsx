...
export default function BlogPostLayout({
  ...
  return (
    <>
      ...
      <main className="prose prose-gray mt-8 pb-20 prose-h4:prose-base dark:prose-invert prose-h1:text-3xl prose-h1:font-bold prose-h1:tracking-tight prose-h2:mt-12 prose-h2:scroll-m-20 prose-h2:text-2xl prose-h2:font-semibold prose-h2:tracking-tight prose-h3:text-xl prose-h3:font-semibold prose-h3:tracking-tight prose-h4:font-semibold prose-h5:text-lg prose-h5:font-semibold prose-h6:text-base prose-h6:font-semibold prose-strong:font-semibold prose-blockquote:border-l-4 prose-blockquote:border-blue-500 prose-blockquote:bg-gradient-to-r prose-blockquote:from-blue-50/80 prose-blockquote:via-purple-50/60 prose-blockquote:to-blue-50/80 prose-blockquote:py-6 prose-blockquote:px-8 prose-blockquote:rounded-lg prose-blockquote:shadow-sm dark:prose-blockquote:from-blue-950/30 dark:prose-blockquote:via-purple-950/20 dark:prose-blockquote:to-blue-950/30 dark:prose-blockquote:shadow-zinc-900/20 prose-code:bg-zinc-200/80 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:text-sm prose-code:font-mono dark:prose-code:bg-zinc-700/80 prose-pre:bg-transparent prose-pre:p-0 prose-pre:shadow-none prose-pre:rounded-none dark:prose-pre:bg-transparent">
